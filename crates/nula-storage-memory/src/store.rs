...
//!
//! `MemoryStore` is the inner mutable state behind [`crate::MemoryDatabase`].
...
//! primary table.
//!
//! The store is **not** thread-safe on its own. [`crate::MemoryDatabase`]
...
use nula_storage::{DatabaseEventStatus, RejectedReason, SaveEventStatus};
