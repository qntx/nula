...
/// [`crate::RelayPool`] handle.
///
/// `SharedState` itself is `Clone` and `Send + Sync`; cloning costs
/// two `Arc` bumps. The pool keeps one copy in [`crate::RelayPool`]
