...
//! [`crate::RelayPool::stream_events`].

use nula_core::RelayUrl;
use nula_relay::RelayStatus;

/// Cross-cutting notification emitted by a [`crate::RelayPool`].
///
/// Subscribe via [`crate::RelayPool::notifications`]. Fan-out happens
...
pub enum PoolNotification {
    ...
    /// [`crate::RelayPool::add_relay`] of a given url; **not** fired
    ...
    /// [`crate::RelayPool::remove_relay`] or by the pool being shut
