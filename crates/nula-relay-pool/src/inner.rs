...
//!
//! The public [`crate::RelayPool`] handle is a thin `Arc<Inner>`
...
use crate::capabilities::{AtomicRelayCapabilities, RelayCapabilities};
...
/// Heart of the pool. Every public [`crate::RelayPool`] method
