//! Tunables for [`crate::pool::RelayPool`].
...
/// Configuration for a [`crate::pool::RelayPool`] instance.
///
/// Construct via [`Self::new`] and chain method calls, or hand the
/// fully-populated struct to [`crate::pool::RelayPoolBuilder::options`].
...
pub struct RelayPoolOptions {
    ...
    /// [`crate::pool::Error::TooManyRelays`].
    pub max_relays: Option<NonZeroUsize>,

    /// Buffer size for the [`crate::pool::PoolNotification`] broadcast
    ...
    /// [`crate::pool::RelayPool::stream_events`]. Older entries fall out
    ...
    /// that flows through [`crate::pool::RelayPool::stream_events`]. The
