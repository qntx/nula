...
//! frames. Concrete implementations live in [`crate::transport::default`] (the
//! `tokio-tungstenite`-backed `DefaultTransport`) and [`crate::transport::mock`]
...
/// stable Rust.
///
/// [`Message::Ping`]: crate::transport::Message::Ping
